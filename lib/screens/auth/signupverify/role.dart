 ...
 Widget _buildRoleSelectionGrid() {
  return Column(
    children: [
        ...
        children: [
          Expanded(
            child: _buildRoleCard(
              'Driver',
              icon: null, // No icon for Driver
              imagePath: 'assets/images/roledriver.png', // Image for Driver
            ),
          ),
          ...
          Expanded(
            child: _buildRoleCard(
              'Passenger',
              icon: null, // No icon for Passenger
              imagePath: 'assets/images/rolepassenger.png', // Image for Passenger
            ),
          ),
        ],
      ),
      ...
      _buildRoleCard(
        'Both',
        icon: null, // Icon for Both
        imagePath: null, // No image for Both
      ),
    ],
  );
}
...
Widget _buildRoleCard(
  ...
  return GestureDetector(
    ...
    child: Container(
      ...
      child: Column(
        children: [
          // Display Icon or Image based on input
          if (icon != null)
            Icon(
              icon,
              size: 50,
